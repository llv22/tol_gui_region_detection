...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        ann_file='data/train/annotation_coco_small_bbox.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        metainfo=dict(classes=classes),
        data_root=data_root,
        ann_file='data/val/annotation_coco_small_bbox.json',
        data_prefix=dict(img=image_prefix),
        test_mode=True,
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'data/val/annotation_coco_small_bbox.json',
    metric='bbox',
    format_only=False,
    backend_args=backend_args)
