...
def conf():
    # see: using classes 80
    argparser = argparse.ArgumentParser()
    argparser.add_argument("--input_folder", type=str, default="../../test_screendata/mobile_pc_web_osworld")
    argparser.add_argument("--model_config", type=str, default="configs/dino/dino-4scale_r50_improved_8xb2-12e_coco.py")
    ...
    argparser.add_argument("--checkpoint", type=str, default="work_dirs/dino-4scale_r50_improved_8xb2-12e_coco/dino-4scale_r50_improved_8xb2-12e_coco_20230818_162607-6f47a913.pth")
